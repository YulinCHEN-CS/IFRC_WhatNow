...
router.post('/get_apis', apiController.getAllApis);

router.post('/get_api_by_id', apiValidator.getApiByIdValidator, apiController.getApiById);

router.post('/add_api', apiValidator.addApiValidator, apiController.addApi);

router.post('/update_api', apiValidator.updateApiValidator, apiController.updateApi);

router.post('/delete_api', apiValidator.deleteApiValidator, apiController.deleteApi);
