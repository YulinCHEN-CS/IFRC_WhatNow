const { selectFromDatabase, updateToDatabase, deleteFromDatabase } = require("../controllers/content.controller");
const { attributeTableName, contentTableName, listAttributes } = require("../config");
...
module.exports = function(app) {
    ...
    app.get('/', async (req, res) => {
        try {
            ...
            attribute = await selectFromDatabase(attributeTableName, [], null, null) || {};

            contents = await selectFromDatabase(contentTableName, listAttributes, key, value) || {};
    ...
    app.post('/update', async (req, res) => {
        try {
            ...
            await updateToDatabase(contentTableName, object);
    ...
    app.post('/delete', async (req, res) => {
        try {
            ...
            if (key && value && key !== ''){
                await deleteFromDatabase(contentTableName, key, value);
                success = true;
     ...
     */
    app.post('/update-attribute', async (req, res) => {
        try {
            const object = req.body;

            console.log('object: ', object);
            
            await updateToDatabase(attributeTableName, object);
